$(document).ready(function () {
  document.getElementById("myGift").addEventListener("click", function () {
    var song = document.createElement("audio");
    song.setAttribute("src", "./music/HappyBirthdayPianoVersion.mp3");
    $("body").append(song);
    song.loop = true;
    song.play();
    $("#myBox").fadeOut(1000, function () {
      ...
      $("#banner").children().fadeIn(3000);
      $("#cake_container").children().fadeIn(3000);
      $("#text-content").fadeIn(3000);
      document.getElementById("bulb_container").style.display = "flex";
      document.getElementById("text-content").style.display = "grid";
      document.getElementById("banner").style.display = "flex";
      document.getElementById("cake_container").style.display = "inline";
    ...
    setTimeout(function () {
      document
        .getElementById("cake_container")
        .getElementsByTagName("img")[0].style.display = "none";
      document
        .getElementById("cake_container")
        .getElementsByClassName("message")[0].style.display = "inline";
    ...
    setTimeout(function () {
      document.getElementById("bulb_container").style.display = "none";
      document.getElementById("text-content").style.display = "none";
      document.getElementById("banner").style.display = "none";
      document.getElementById("cake_container").style.display = "none";
